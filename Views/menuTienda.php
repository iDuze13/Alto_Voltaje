        ...
        <div class="row d-flex justify-content-center align-items-stretch">
            <div class="col-12 col-md-6 col-xl-3 p-b-30 d-flex">
                <div class="block1 wrap-pic-w w-100" style="height: 350px; display: flex; flex-direction: column; justify-content: flex-end;">
                    <img src="images/banner-01.png" alt="IMG-BANNER" style="object-fit: cover; height: 200px; width: 100%;">
            ...
            <div class="col-12 col-md-6 col-xl-3 p-b-30 d-flex">
                <div class="block1 wrap-pic-w w-100" style="height: 350px; display: flex; flex-direction: column;justify-content: flex-end;">
                    <img src="images/banner-02.png" alt="IMG-BANNER" style="object-fit: cover; height: 200px; width: 100%;">
                    <a href="product.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3 flex-grow-1">
                        <div class="block1-txt-child1 flex-col-l">
            ...
            <div class="col-12 col-md-6 col-xl-3 p-b-30 d-flex">
                <div class="block1 wrap-pic-w w-100" style="height: 350px; display: flex; flex-direction: column; justify-content: flex-end;">
                    <img src="images/banner-03.png" alt="IMG-BANNER" style="object-fit: cover; height: 200px; width: 100%;">
                    <a href="product.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3 flex-grow-1">
                        <div class="block1-txt-child1 flex-col-l">
            ...
            <div class="col-12 col-md-6 col-xl-3 p-b-30 d-flex">
                <div class="block1 wrap-pic-w w-100" style="height: 350px; display: flex; flex-direction: column; justify-content: flex-end;">
                    <img src="images/banner-04.png" alt="IMG-BANNER" style="object-fit: cover; height: 200px; width: 100%;">
                    <a href="product.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3 flex-grow-1">
                        <div class="block1-txt-child1 flex-col-l">
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="images/product-06.png" alt="IMG-PRODUCT">
