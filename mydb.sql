...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2025 a las 00:42:34
...
(1, 'electronica', 'muchas cosas enchufadas', NULL, '', '2025-10-02 13:38:40', 1),
...
(1011, 1010, '27-32460182-5', '2025-08-19', 1651.00, 'Maniana'),
(1012, 1012, '20-51231123-5', '2025-01-16', 99999999.99, 'Maniana'),
(1013, 1011, '20-21458452-9', '2025-04-10', 200.00, 'Tarde');
...
(896467, 2, 'guantes', 'jjjjjjjjjj', 'sx569541s', '23163165156', 'alem', 15000.00, 20000.00, 18000.00, 33.33, 50, 'producto_68f2bf469a058.png', 'Assets/images/uploads/', 'Activo', 1, 0, 1, 1);
...
ALTER TABLE `administrador`
  ...
  ADD UNIQUE KEY `uk_admin_usuario` (`id_Usuario`);
...
ALTER TABLE `empleado`
  ...
  ADD UNIQUE KEY `uk_empleado_usuario` (`id_Usuario`);
...
ALTER TABLE `producto`
  ADD PRIMARY KEY (`idProducto`,`SubCategoria_idSubCategoria`,`Inventario_id_Inventario`,`Proveedor_id_Proveedor`),
  ADD UNIQUE KEY `SKU_UNIQUE` (`SKU`),
  ADD UNIQUE KEY `uq_producto_id_subcat` (`idProducto`,`SubCategoria_idSubCategoria`),
...
--
ALTER TABLE `administrador`
  MODIFY `id_Administrador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1517;
...
--
ALTER TABLE `producto`
  MODIFY `idProducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=896468;
...
ALTER TABLE `venta`
  ...
  ADD CONSTRAINT `fk_Venta_Empleado1` FOREIGN KEY (`Empleado_id_Empleado`) REFERENCES `empleado` (`id_Empleado`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
