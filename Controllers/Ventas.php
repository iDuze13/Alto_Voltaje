 ...
 * Maneja todo el flujo de ventas del sistema
 */
class Ventas extends Controllers {
    
    // NO declaramos $model aquí porque ya está en la clase padre Controllers
    ...
    private function mostrarVentas() {
        ...
        // Llamada a la vista (asegúrate que el archivo se llame ventas.php en Views/Ventas/)
